  ...
  return (
    <div className="side-panel">
      ...
      <div className="panel-section">
        ...
        {player && !player.alive && (
          <div style={{ color: '#e74c3c', fontSize: 7, marginTop: 4 }}>You have been eliminated</div>
        )}
      </div>
      ...
      {/* Remaining count — no names or roles revealed */}
      <div className="panel-section">
      ...
      {/* Chat */}
      <div className="panel-section" style={{ flex: 1, minHeight: 100, display: 'flex', flexDirection: 'column' }}>
        <Chat
